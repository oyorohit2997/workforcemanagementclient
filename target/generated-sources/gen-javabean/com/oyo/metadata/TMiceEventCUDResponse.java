            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map298.size);
                ...
                for (int _i301 = 0; _i301 < _map298.size; ++_i301)
                {
                  ...
                  struct.errorList.put(_key299, _val300);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TMiceEventCUDResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.errorList != null) {
        oprot.writeFieldBegin(ERROR_LIST_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter302 : struct.errorList.entrySet())
          {
      ...
      if (struct.isSetErrorList()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter303 : struct.errorList.entrySet())
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map304.size);
          java.lang.String _key305;
          java.lang.String _val306;
          for (int _i307 = 0; _i307 < _map304.size; ++_i307)
          {
            _key305 = iprot.readString();
            _val306 = iprot.readString();
            struct.errorList.put(_key305, _val306);
          }
        }
        struct.setErrorListIsSet(true);
      }
