...
public class TLocalityCUDResponse implements org.apache.thrift.TBase<TLocalityCUDResponse, TLocalityCUDResponse._Fields>, java.io.Serializable, Cloneable, Comparable<TLocalityCUDResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TLocalityCUDResponse");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TLocalityCUDResponseStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TLocalityCUDResponseTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TLocalityCUDResponse.class, metaDataMap);
  }

  public TLocalityCUDResponse() {
  }
   ...
   */
  public TLocalityCUDResponse(TLocalityCUDResponse other) {
  ...
  public TLocalityCUDResponse deepCopy() {
    return new TLocalityCUDResponse(this);
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TLocalityCUDResponse)
      return this.equals((TLocalityCUDResponse)that);
    return false;
  }

  public boolean equals(TLocalityCUDResponse that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TLocalityCUDResponse other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TLocalityCUDResponse(");
    boolean first = true;
  ...
  private static class TLocalityCUDResponseStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TLocalityCUDResponseStandardScheme getScheme() {
      return new TLocalityCUDResponseStandardScheme();
    }
  }

  private static class TLocalityCUDResponseStandardScheme extends org.apache.thrift.scheme.StandardScheme<TLocalityCUDResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TLocalityCUDResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map478.size);
                java.lang.String _key479;
                java.lang.String _val480;
                for (int _i481 = 0; _i481 < _map478.size; ++_i481)
                {
                  _key479 = iprot.readString();
                  _val480 = iprot.readString();
                  struct.errorList.put(_key479, _val480);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TLocalityCUDResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.errorList != null) {
        oprot.writeFieldBegin(ERROR_LIST_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter482 : struct.errorList.entrySet())
          {
  ...
  private static class TLocalityCUDResponseTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TLocalityCUDResponseTupleScheme getScheme() {
      return new TLocalityCUDResponseTupleScheme();
    }
  }

  private static class TLocalityCUDResponseTupleScheme extends org.apache.thrift.scheme.TupleScheme<TLocalityCUDResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TLocalityCUDResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetErrorList()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter483 : struct.errorList.entrySet())
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TLocalityCUDResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map484.size);
          java.lang.String _key485;
          java.lang.String _val486;
          for (int _i487 = 0; _i487 < _map484.size; ++_i487)
          {
            _key485 = iprot.readString();
            _val486 = iprot.readString();
            struct.errorList.put(_key485, _val486);
          }
        }
        struct.setErrorListIsSet(true);
      }
