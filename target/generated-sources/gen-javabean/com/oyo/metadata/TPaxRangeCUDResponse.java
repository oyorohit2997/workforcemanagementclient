...
public class TPaxRangeCUDResponse implements org.apache.thrift.TBase<TPaxRangeCUDResponse, TPaxRangeCUDResponse._Fields>, java.io.Serializable, Cloneable, Comparable<TPaxRangeCUDResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TPaxRangeCUDResponse");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TPaxRangeCUDResponseStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TPaxRangeCUDResponseTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TPaxRangeCUDResponse.class, metaDataMap);
  }

  public TPaxRangeCUDResponse() {
  }
   ...
   */
  public TPaxRangeCUDResponse(TPaxRangeCUDResponse other) {
  ...
  public TPaxRangeCUDResponse deepCopy() {
    return new TPaxRangeCUDResponse(this);
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TPaxRangeCUDResponse)
      return this.equals((TPaxRangeCUDResponse)that);
    return false;
  }

  public boolean equals(TPaxRangeCUDResponse that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TPaxRangeCUDResponse other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TPaxRangeCUDResponse(");
    boolean first = true;
  ...
  private static class TPaxRangeCUDResponseStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TPaxRangeCUDResponseStandardScheme getScheme() {
      return new TPaxRangeCUDResponseStandardScheme();
    }
  }

  private static class TPaxRangeCUDResponseStandardScheme extends org.apache.thrift.scheme.StandardScheme<TPaxRangeCUDResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TPaxRangeCUDResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map558.size);
                ...
                for (int _i561 = 0; _i561 < _map558.size; ++_i561)
                {
                  ...
                  struct.errorList.put(_key559, _val560);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TPaxRangeCUDResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.errorList != null) {
        oprot.writeFieldBegin(ERROR_LIST_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter562 : struct.errorList.entrySet())
          {
  ...
  private static class TPaxRangeCUDResponseTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TPaxRangeCUDResponseTupleScheme getScheme() {
      return new TPaxRangeCUDResponseTupleScheme();
    }
  }

  private static class TPaxRangeCUDResponseTupleScheme extends org.apache.thrift.scheme.TupleScheme<TPaxRangeCUDResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TPaxRangeCUDResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetErrorList()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter563 : struct.errorList.entrySet())
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TPaxRangeCUDResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map564.size);
          java.lang.String _key565;
          java.lang.String _val566;
          for (int _i567 = 0; _i567 < _map564.size; ++_i567)
          {
            _key565 = iprot.readString();
            _val566 = iprot.readString();
            struct.errorList.put(_key565, _val566);
          }
        }
        struct.setErrorListIsSet(true);
      }
