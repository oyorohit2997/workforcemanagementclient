...
public class TPickupPointCUDResponse implements org.apache.thrift.TBase<TPickupPointCUDResponse, TPickupPointCUDResponse._Fields>, java.io.Serializable, Cloneable, Comparable<TPickupPointCUDResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TPickupPointCUDResponse");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TPickupPointCUDResponseStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TPickupPointCUDResponseTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TPickupPointCUDResponse.class, metaDataMap);
  }

  public TPickupPointCUDResponse() {
  }
   ...
   */
  public TPickupPointCUDResponse(TPickupPointCUDResponse other) {
  ...
  public TPickupPointCUDResponse deepCopy() {
    return new TPickupPointCUDResponse(this);
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TPickupPointCUDResponse)
      return this.equals((TPickupPointCUDResponse)that);
    return false;
  }

  public boolean equals(TPickupPointCUDResponse that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TPickupPointCUDResponse other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TPickupPointCUDResponse(");
    boolean first = true;
  ...
  private static class TPickupPointCUDResponseStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TPickupPointCUDResponseStandardScheme getScheme() {
      return new TPickupPointCUDResponseStandardScheme();
    }
  }

  private static class TPickupPointCUDResponseStandardScheme extends org.apache.thrift.scheme.StandardScheme<TPickupPointCUDResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TPickupPointCUDResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map438.size);
                java.lang.String _key439;
                java.lang.String _val440;
                for (int _i441 = 0; _i441 < _map438.size; ++_i441)
                {
                  _key439 = iprot.readString();
                  _val440 = iprot.readString();
                  struct.errorList.put(_key439, _val440);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TPickupPointCUDResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.errorList != null) {
        oprot.writeFieldBegin(ERROR_LIST_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter442 : struct.errorList.entrySet())
          {
  ...
  private static class TPickupPointCUDResponseTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TPickupPointCUDResponseTupleScheme getScheme() {
      return new TPickupPointCUDResponseTupleScheme();
    }
  }

  private static class TPickupPointCUDResponseTupleScheme extends org.apache.thrift.scheme.TupleScheme<TPickupPointCUDResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TPickupPointCUDResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetErrorList()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter443 : struct.errorList.entrySet())
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TPickupPointCUDResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map444.size);
          java.lang.String _key445;
          java.lang.String _val446;
          for (int _i447 = 0; _i447 < _map444.size; ++_i447)
          {
            _key445 = iprot.readString();
            _val446 = iprot.readString();
            struct.errorList.put(_key445, _val446);
          }
        }
        struct.setErrorListIsSet(true);
      }
