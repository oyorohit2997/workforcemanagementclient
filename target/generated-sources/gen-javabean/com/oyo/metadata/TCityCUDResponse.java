...
public class TCityCUDResponse implements org.apache.thrift.TBase<TCityCUDResponse, TCityCUDResponse._Fields>, java.io.Serializable, Cloneable, Comparable<TCityCUDResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TCityCUDResponse");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TCityCUDResponseStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TCityCUDResponseTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TCityCUDResponse.class, metaDataMap);
  }

  public TCityCUDResponse() {
  }
   ...
   */
  public TCityCUDResponse(TCityCUDResponse other) {
  ...
  public TCityCUDResponse deepCopy() {
    return new TCityCUDResponse(this);
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TCityCUDResponse)
      return this.equals((TCityCUDResponse)that);
    return false;
  }

  public boolean equals(TCityCUDResponse that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TCityCUDResponse other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TCityCUDResponse(");
    boolean first = true;
  ...
  private static class TCityCUDResponseStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TCityCUDResponseStandardScheme getScheme() {
      return new TCityCUDResponseStandardScheme();
    }
  }

  private static class TCityCUDResponseStandardScheme extends org.apache.thrift.scheme.StandardScheme<TCityCUDResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TCityCUDResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map58.size);
                ...
                for (int _i61 = 0; _i61 < _map58.size; ++_i61)
                {
                  ...
                  struct.errorList.put(_key59, _val60);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TCityCUDResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.errorList != null) {
        oprot.writeFieldBegin(ERROR_LIST_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter62 : struct.errorList.entrySet())
          {
  ...
  private static class TCityCUDResponseTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TCityCUDResponseTupleScheme getScheme() {
      return new TCityCUDResponseTupleScheme();
    }
  }

  private static class TCityCUDResponseTupleScheme extends org.apache.thrift.scheme.TupleScheme<TCityCUDResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TCityCUDResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetErrorList()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter63 : struct.errorList.entrySet())
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TCityCUDResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map64.size);
          ...
          for (int _i67 = 0; _i67 < _map64.size; ++_i67)
          {
            ...
            struct.errorList.put(_key65, _val66);
          }
        }
        struct.setErrorListIsSet(true);
      }
