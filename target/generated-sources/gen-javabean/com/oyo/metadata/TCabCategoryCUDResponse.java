...
public class TCabCategoryCUDResponse implements org.apache.thrift.TBase<TCabCategoryCUDResponse, TCabCategoryCUDResponse._Fields>, java.io.Serializable, Cloneable, Comparable<TCabCategoryCUDResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TCabCategoryCUDResponse");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TCabCategoryCUDResponseStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TCabCategoryCUDResponseTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TCabCategoryCUDResponse.class, metaDataMap);
  }

  public TCabCategoryCUDResponse() {
  }
   ...
   */
  public TCabCategoryCUDResponse(TCabCategoryCUDResponse other) {
  ...
  public TCabCategoryCUDResponse deepCopy() {
    return new TCabCategoryCUDResponse(this);
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TCabCategoryCUDResponse)
      return this.equals((TCabCategoryCUDResponse)that);
    return false;
  }

  public boolean equals(TCabCategoryCUDResponse that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TCabCategoryCUDResponse other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TCabCategoryCUDResponse(");
    boolean first = true;
  ...
  private static class TCabCategoryCUDResponseStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TCabCategoryCUDResponseStandardScheme getScheme() {
      return new TCabCategoryCUDResponseStandardScheme();
    }
  }

  private static class TCabCategoryCUDResponseStandardScheme extends org.apache.thrift.scheme.StandardScheme<TCabCategoryCUDResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TCabCategoryCUDResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map588.size);
                java.lang.String _key589;
                java.lang.String _val590;
                for (int _i591 = 0; _i591 < _map588.size; ++_i591)
                {
                  _key589 = iprot.readString();
                  _val590 = iprot.readString();
                  struct.errorList.put(_key589, _val590);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TCabCategoryCUDResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.errorList != null) {
        oprot.writeFieldBegin(ERROR_LIST_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter592 : struct.errorList.entrySet())
          {
  ...
  private static class TCabCategoryCUDResponseTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TCabCategoryCUDResponseTupleScheme getScheme() {
      return new TCabCategoryCUDResponseTupleScheme();
    }
  }

  private static class TCabCategoryCUDResponseTupleScheme extends org.apache.thrift.scheme.TupleScheme<TCabCategoryCUDResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TCabCategoryCUDResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetErrorList()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter593 : struct.errorList.entrySet())
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TCabCategoryCUDResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map594.size);
          java.lang.String _key595;
          java.lang.String _val596;
          for (int _i597 = 0; _i597 < _map594.size; ++_i597)
          {
            _key595 = iprot.readString();
            _val596 = iprot.readString();
            struct.errorList.put(_key595, _val596);
          }
        }
        struct.setErrorListIsSet(true);
      }
