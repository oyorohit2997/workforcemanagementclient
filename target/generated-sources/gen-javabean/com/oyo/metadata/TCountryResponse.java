...
public class TCountryResponse implements org.apache.thrift.TBase<TCountryResponse, TCountryResponse._Fields>, java.io.Serializable, Cloneable, Comparable<TCountryResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TCountryResponse");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TCountryResponseStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TCountryResponseTupleSchemeFactory();

  private TCountry country; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.COUNTRY, new org.apache.thrift.meta_data.FieldMetaData("country", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TCountry.class)));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TCountryResponse.class, metaDataMap);
  }

  public TCountryResponse() {
  }
   ...
   */
  public TCountryResponse(TCountryResponse other) {
    if (other.isSetCountry()) {
      this.country = new TCountry(other.country);
    }
  ...
  public TCountryResponse deepCopy() {
    return new TCountryResponse(this);
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TCountryResponse)
      return this.equals((TCountryResponse)that);
    return false;
  }

  public boolean equals(TCountryResponse that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TCountryResponse other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TCountryResponse(");
    boolean first = true;
  ...
  private static class TCountryResponseStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TCountryResponseStandardScheme getScheme() {
      return new TCountryResponseStandardScheme();
    }
  }

  private static class TCountryResponseStandardScheme extends org.apache.thrift.scheme.StandardScheme<TCountryResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TCountryResponse struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TCountryResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.errorList != null) {
        oprot.writeFieldBegin(ERROR_LIST_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter92 : struct.errorList.entrySet())
          {
  ...
  private static class TCountryResponseTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TCountryResponseTupleScheme getScheme() {
      return new TCountryResponseTupleScheme();
    }
  }

  private static class TCountryResponseTupleScheme extends org.apache.thrift.scheme.TupleScheme<TCountryResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TCountryResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetErrorList()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter93 : struct.errorList.entrySet())
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TCountryResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map94.size);
          ...
          for (int _i97 = 0; _i97 < _map94.size; ++_i97)
          {
            ...
            struct.errorList.put(_key95, _val96);
          }
        }
        struct.setErrorListIsSet(true);
      }
