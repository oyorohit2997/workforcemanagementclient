...
public class TCatalogSectionCUDResponse implements org.apache.thrift.TBase<TCatalogSectionCUDResponse, TCatalogSectionCUDResponse._Fields>, java.io.Serializable, Cloneable, Comparable<TCatalogSectionCUDResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TCatalogSectionCUDResponse");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TCatalogSectionCUDResponseStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TCatalogSectionCUDResponseTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TCatalogSectionCUDResponse.class, metaDataMap);
  }

  public TCatalogSectionCUDResponse() {
  }
   ...
   */
  public TCatalogSectionCUDResponse(TCatalogSectionCUDResponse other) {
  ...
  public TCatalogSectionCUDResponse deepCopy() {
    return new TCatalogSectionCUDResponse(this);
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TCatalogSectionCUDResponse)
      return this.equals((TCatalogSectionCUDResponse)that);
    return false;
  }

  public boolean equals(TCatalogSectionCUDResponse that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TCatalogSectionCUDResponse other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TCatalogSectionCUDResponse(");
    boolean first = true;
  ...
  private static class TCatalogSectionCUDResponseStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TCatalogSectionCUDResponseStandardScheme getScheme() {
      return new TCatalogSectionCUDResponseStandardScheme();
    }
  }

  private static class TCatalogSectionCUDResponseStandardScheme extends org.apache.thrift.scheme.StandardScheme<TCatalogSectionCUDResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TCatalogSectionCUDResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map398.size);
                java.lang.String _key399;
                java.lang.String _val400;
                for (int _i401 = 0; _i401 < _map398.size; ++_i401)
                {
                  _key399 = iprot.readString();
                  _val400 = iprot.readString();
                  struct.errorList.put(_key399, _val400);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TCatalogSectionCUDResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.errorList != null) {
        oprot.writeFieldBegin(ERROR_LIST_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter402 : struct.errorList.entrySet())
          {
  ...
  private static class TCatalogSectionCUDResponseTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TCatalogSectionCUDResponseTupleScheme getScheme() {
      return new TCatalogSectionCUDResponseTupleScheme();
    }
  }

  private static class TCatalogSectionCUDResponseTupleScheme extends org.apache.thrift.scheme.TupleScheme<TCatalogSectionCUDResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TCatalogSectionCUDResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetErrorList()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter403 : struct.errorList.entrySet())
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TCatalogSectionCUDResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map404.size);
          java.lang.String _key405;
          java.lang.String _val406;
          for (int _i407 = 0; _i407 < _map404.size; ++_i407)
          {
            _key405 = iprot.readString();
            _val406 = iprot.readString();
            struct.errorList.put(_key405, _val406);
          }
        }
        struct.setErrorListIsSet(true);
      }
