...
public class TFoodTypeCUDResponse implements org.apache.thrift.TBase<TFoodTypeCUDResponse, TFoodTypeCUDResponse._Fields>, java.io.Serializable, Cloneable, Comparable<TFoodTypeCUDResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TFoodTypeCUDResponse");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TFoodTypeCUDResponseStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TFoodTypeCUDResponseTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TFoodTypeCUDResponse.class, metaDataMap);
  }

  public TFoodTypeCUDResponse() {
  }
   ...
   */
  public TFoodTypeCUDResponse(TFoodTypeCUDResponse other) {
  ...
  public TFoodTypeCUDResponse deepCopy() {
    return new TFoodTypeCUDResponse(this);
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TFoodTypeCUDResponse)
      return this.equals((TFoodTypeCUDResponse)that);
    return false;
  }

  public boolean equals(TFoodTypeCUDResponse that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TFoodTypeCUDResponse other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TFoodTypeCUDResponse(");
    boolean first = true;
  ...
  private static class TFoodTypeCUDResponseStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TFoodTypeCUDResponseStandardScheme getScheme() {
      return new TFoodTypeCUDResponseStandardScheme();
    }
  }

  private static class TFoodTypeCUDResponseStandardScheme extends org.apache.thrift.scheme.StandardScheme<TFoodTypeCUDResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TFoodTypeCUDResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map518.size);
                java.lang.String _key519;
                java.lang.String _val520;
                for (int _i521 = 0; _i521 < _map518.size; ++_i521)
                {
                  _key519 = iprot.readString();
                  _val520 = iprot.readString();
                  struct.errorList.put(_key519, _val520);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TFoodTypeCUDResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.errorList != null) {
        oprot.writeFieldBegin(ERROR_LIST_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter522 : struct.errorList.entrySet())
          {
  ...
  private static class TFoodTypeCUDResponseTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TFoodTypeCUDResponseTupleScheme getScheme() {
      return new TFoodTypeCUDResponseTupleScheme();
    }
  }

  private static class TFoodTypeCUDResponseTupleScheme extends org.apache.thrift.scheme.TupleScheme<TFoodTypeCUDResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TFoodTypeCUDResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetErrorList()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter523 : struct.errorList.entrySet())
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TFoodTypeCUDResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map524.size);
          ...
          for (int _i527 = 0; _i527 < _map524.size; ++_i527)
          {
            ...
            struct.errorList.put(_key525, _val526);
          }
        }
        struct.setErrorListIsSet(true);
      }
