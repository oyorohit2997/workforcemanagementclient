...
public class TStateResponse implements org.apache.thrift.TBase<TStateResponse, TStateResponse._Fields>, java.io.Serializable, Cloneable, Comparable<TStateResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TStateResponse");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TStateResponseStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TStateResponseTupleSchemeFactory();

  private TState state; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.STATE, new org.apache.thrift.meta_data.FieldMetaData("state", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TState.class)));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TStateResponse.class, metaDataMap);
  }

  public TStateResponse() {
  }
   ...
   */
  public TStateResponse(TStateResponse other) {
    if (other.isSetState()) {
      this.state = new TState(other.state);
    }
  ...
  public TStateResponse deepCopy() {
    return new TStateResponse(this);
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TStateResponse)
      return this.equals((TStateResponse)that);
    return false;
  }

  public boolean equals(TStateResponse that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TStateResponse other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TStateResponse(");
    boolean first = true;
  ...
  private static class TStateResponseStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TStateResponseStandardScheme getScheme() {
      return new TStateResponseStandardScheme();
    }
  }

  private static class TStateResponseStandardScheme extends org.apache.thrift.scheme.StandardScheme<TStateResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TStateResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map68.size);
                ...
                for (int _i71 = 0; _i71 < _map68.size; ++_i71)
                {
                  ...
                  struct.errorList.put(_key69, _val70);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TStateResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.errorList != null) {
        oprot.writeFieldBegin(ERROR_LIST_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter72 : struct.errorList.entrySet())
          {
  ...
  private static class TStateResponseTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TStateResponseTupleScheme getScheme() {
      return new TStateResponseTupleScheme();
    }
  }

  private static class TStateResponseTupleScheme extends org.apache.thrift.scheme.TupleScheme<TStateResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TStateResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetErrorList()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter73 : struct.errorList.entrySet())
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TStateResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map74.size);
          ...
          for (int _i77 = 0; _i77 < _map74.size; ++_i77)
          {
            ...
            struct.errorList.put(_key75, _val76);
          }
        }
        struct.setErrorListIsSet(true);
      }
