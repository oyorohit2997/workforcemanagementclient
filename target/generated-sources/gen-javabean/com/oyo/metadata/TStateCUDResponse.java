...
public class TStateCUDResponse implements org.apache.thrift.TBase<TStateCUDResponse, TStateCUDResponse._Fields>, java.io.Serializable, Cloneable, Comparable<TStateCUDResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TStateCUDResponse");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TStateCUDResponseStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TStateCUDResponseTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TStateCUDResponse.class, metaDataMap);
  }

  public TStateCUDResponse() {
  }
   ...
   */
  public TStateCUDResponse(TStateCUDResponse other) {
  ...
  public TStateCUDResponse deepCopy() {
    return new TStateCUDResponse(this);
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TStateCUDResponse)
      return this.equals((TStateCUDResponse)that);
    return false;
  }

  public boolean equals(TStateCUDResponse that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TStateCUDResponse other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TStateCUDResponse(");
    boolean first = true;
  ...
  private static class TStateCUDResponseStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TStateCUDResponseStandardScheme getScheme() {
      return new TStateCUDResponseStandardScheme();
    }
  }

  private static class TStateCUDResponseStandardScheme extends org.apache.thrift.scheme.StandardScheme<TStateCUDResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TStateCUDResponse struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TStateCUDResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.errorList != null) {
        oprot.writeFieldBegin(ERROR_LIST_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter82 : struct.errorList.entrySet())
          {
  ...
  private static class TStateCUDResponseTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TStateCUDResponseTupleScheme getScheme() {
      return new TStateCUDResponseTupleScheme();
    }
  }

  private static class TStateCUDResponseTupleScheme extends org.apache.thrift.scheme.TupleScheme<TStateCUDResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TStateCUDResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetErrorList()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter83 : struct.errorList.entrySet())
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TStateCUDResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map84.size);
          ...
          for (int _i87 = 0; _i87 < _map84.size; ++_i87)
          {
            ...
            struct.errorList.put(_key85, _val86);
          }
        }
        struct.setErrorListIsSet(true);
      }
