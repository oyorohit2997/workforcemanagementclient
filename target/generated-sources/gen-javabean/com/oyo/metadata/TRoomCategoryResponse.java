            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map228.size);
                java.lang.String _key229;
                java.lang.String _val230;
                for (int _i231 = 0; _i231 < _map228.size; ++_i231)
                {
                  _key229 = iprot.readString();
                  _val230 = iprot.readString();
                  struct.errorList.put(_key229, _val230);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TRoomCategoryResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.errorList != null) {
        oprot.writeFieldBegin(ERROR_LIST_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter232 : struct.errorList.entrySet())
          {
      ...
      if (struct.isSetErrorList()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter233 : struct.errorList.entrySet())
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map234.size);
          ...
          for (int _i237 = 0; _i237 < _map234.size; ++_i237)
          {
            ...
            struct.errorList.put(_key235, _val236);
          }
        }
        struct.setErrorListIsSet(true);
      }
