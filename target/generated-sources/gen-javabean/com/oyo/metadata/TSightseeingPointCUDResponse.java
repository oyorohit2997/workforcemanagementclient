...
public class TSightseeingPointCUDResponse implements org.apache.thrift.TBase<TSightseeingPointCUDResponse, TSightseeingPointCUDResponse._Fields>, java.io.Serializable, Cloneable, Comparable<TSightseeingPointCUDResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TSightseeingPointCUDResponse");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TSightseeingPointCUDResponseStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TSightseeingPointCUDResponseTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TSightseeingPointCUDResponse.class, metaDataMap);
  }

  public TSightseeingPointCUDResponse() {
  }
   ...
   */
  public TSightseeingPointCUDResponse(TSightseeingPointCUDResponse other) {
  ...
  public TSightseeingPointCUDResponse deepCopy() {
    return new TSightseeingPointCUDResponse(this);
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TSightseeingPointCUDResponse)
      return this.equals((TSightseeingPointCUDResponse)that);
    return false;
  }

  public boolean equals(TSightseeingPointCUDResponse that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TSightseeingPointCUDResponse other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TSightseeingPointCUDResponse(");
    boolean first = true;
  ...
  private static class TSightseeingPointCUDResponseStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TSightseeingPointCUDResponseStandardScheme getScheme() {
      return new TSightseeingPointCUDResponseStandardScheme();
    }
  }

  private static class TSightseeingPointCUDResponseStandardScheme extends org.apache.thrift.scheme.StandardScheme<TSightseeingPointCUDResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TSightseeingPointCUDResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map418.size);
                java.lang.String _key419;
                java.lang.String _val420;
                for (int _i421 = 0; _i421 < _map418.size; ++_i421)
                {
                  _key419 = iprot.readString();
                  _val420 = iprot.readString();
                  struct.errorList.put(_key419, _val420);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TSightseeingPointCUDResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.errorList != null) {
        oprot.writeFieldBegin(ERROR_LIST_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter422 : struct.errorList.entrySet())
          {
  ...
  private static class TSightseeingPointCUDResponseTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TSightseeingPointCUDResponseTupleScheme getScheme() {
      return new TSightseeingPointCUDResponseTupleScheme();
    }
  }

  private static class TSightseeingPointCUDResponseTupleScheme extends org.apache.thrift.scheme.TupleScheme<TSightseeingPointCUDResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TSightseeingPointCUDResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetErrorList()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter423 : struct.errorList.entrySet())
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TSightseeingPointCUDResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map424.size);
          java.lang.String _key425;
          java.lang.String _val426;
          for (int _i427 = 0; _i427 < _map424.size; ++_i427)
          {
            _key425 = iprot.readString();
            _val426 = iprot.readString();
            struct.errorList.put(_key425, _val426);
          }
        }
        struct.setErrorListIsSet(true);
      }
