...
public class TFoodCategoryCUDResponse implements org.apache.thrift.TBase<TFoodCategoryCUDResponse, TFoodCategoryCUDResponse._Fields>, java.io.Serializable, Cloneable, Comparable<TFoodCategoryCUDResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TFoodCategoryCUDResponse");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TFoodCategoryCUDResponseStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TFoodCategoryCUDResponseTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TFoodCategoryCUDResponse.class, metaDataMap);
  }

  public TFoodCategoryCUDResponse() {
  }
   ...
   */
  public TFoodCategoryCUDResponse(TFoodCategoryCUDResponse other) {
  ...
  public TFoodCategoryCUDResponse deepCopy() {
    return new TFoodCategoryCUDResponse(this);
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TFoodCategoryCUDResponse)
      return this.equals((TFoodCategoryCUDResponse)that);
    return false;
  }

  public boolean equals(TFoodCategoryCUDResponse that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TFoodCategoryCUDResponse other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TFoodCategoryCUDResponse(");
    boolean first = true;
  ...
  private static class TFoodCategoryCUDResponseStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TFoodCategoryCUDResponseStandardScheme getScheme() {
      return new TFoodCategoryCUDResponseStandardScheme();
    }
  }

  private static class TFoodCategoryCUDResponseStandardScheme extends org.apache.thrift.scheme.StandardScheme<TFoodCategoryCUDResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TFoodCategoryCUDResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map538.size);
                java.lang.String _key539;
                java.lang.String _val540;
                for (int _i541 = 0; _i541 < _map538.size; ++_i541)
                {
                  _key539 = iprot.readString();
                  _val540 = iprot.readString();
                  struct.errorList.put(_key539, _val540);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TFoodCategoryCUDResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.errorList != null) {
        oprot.writeFieldBegin(ERROR_LIST_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter542 : struct.errorList.entrySet())
          {
  ...
  private static class TFoodCategoryCUDResponseTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TFoodCategoryCUDResponseTupleScheme getScheme() {
      return new TFoodCategoryCUDResponseTupleScheme();
    }
  }

  private static class TFoodCategoryCUDResponseTupleScheme extends org.apache.thrift.scheme.TupleScheme<TFoodCategoryCUDResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TFoodCategoryCUDResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetErrorList()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter543 : struct.errorList.entrySet())
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TFoodCategoryCUDResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map544.size);
          ...
          for (int _i547 = 0; _i547 < _map544.size; ++_i547)
          {
            ...
            struct.errorList.put(_key545, _val546);
          }
        }
        struct.setErrorListIsSet(true);
      }
