...
public class TLocalityResponse implements org.apache.thrift.TBase<TLocalityResponse, TLocalityResponse._Fields>, java.io.Serializable, Cloneable, Comparable<TLocalityResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TLocalityResponse");

  private static final org.apache.thrift.protocol.TField LOCALITY_FIELD_DESC = new org.apache.thrift.protocol.TField("locality", org.apache.thrift.protocol.TType.STRUCT, (short)1);
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TLocalityResponseStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TLocalityResponseTupleSchemeFactory();

  private TLocality locality; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.LOCALITY, new org.apache.thrift.meta_data.FieldMetaData("locality", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TLocality.class)));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TLocalityResponse.class, metaDataMap);
  }

  public TLocalityResponse() {
  }
   ...
   */
  public TLocalityResponse(TLocalityResponse other) {
    if (other.isSetLocality()) {
      this.locality = new TLocality(other.locality);
    }
  ...
  public TLocalityResponse deepCopy() {
    return new TLocalityResponse(this);
  }
  ...
  public void setLocality(TLocality locality) {
    this.locality = locality;
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TLocalityResponse)
      return this.equals((TLocalityResponse)that);
    return false;
  }

  public boolean equals(TLocalityResponse that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TLocalityResponse other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TLocalityResponse(");
    boolean first = true;
  ...
  private static class TLocalityResponseStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TLocalityResponseStandardScheme getScheme() {
      return new TLocalityResponseStandardScheme();
    }
  }

  private static class TLocalityResponseStandardScheme extends org.apache.thrift.scheme.StandardScheme<TLocalityResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TLocalityResponse struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          case 1: // LOCALITY
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.locality = new TLocality();
              struct.locality.read(iprot);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map468.size);
                java.lang.String _key469;
                java.lang.String _val470;
                for (int _i471 = 0; _i471 < _map468.size; ++_i471)
                {
                  _key469 = iprot.readString();
                  _val470 = iprot.readString();
                  struct.errorList.put(_key469, _val470);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TLocalityResponse struct) throws org.apache.thrift.TException {
      struct.validate();

      oprot.writeStructBegin(STRUCT_DESC);
      if (struct.locality != null) {
        oprot.writeFieldBegin(LOCALITY_FIELD_DESC);
        struct.locality.write(oprot);
        oprot.writeFieldEnd();
      }
      ...
      if (struct.errorList != null) {
        oprot.writeFieldBegin(ERROR_LIST_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter472 : struct.errorList.entrySet())
          {
  ...
  private static class TLocalityResponseTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TLocalityResponseTupleScheme getScheme() {
      return new TLocalityResponseTupleScheme();
    }
  }

  private static class TLocalityResponseTupleScheme extends org.apache.thrift.scheme.TupleScheme<TLocalityResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TLocalityResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetErrorList()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter473 : struct.errorList.entrySet())
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TLocalityResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map474.size);
          java.lang.String _key475;
          java.lang.String _val476;
          for (int _i477 = 0; _i477 < _map474.size; ++_i477)
          {
            _key475 = iprot.readString();
            _val476 = iprot.readString();
            struct.errorList.put(_key475, _val476);
          }
        }
        struct.setErrorListIsSet(true);
      }
