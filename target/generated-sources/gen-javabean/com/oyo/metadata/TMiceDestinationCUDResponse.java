...
public class TMiceDestinationCUDResponse implements org.apache.thrift.TBase<TMiceDestinationCUDResponse, TMiceDestinationCUDResponse._Fields>, java.io.Serializable, Cloneable, Comparable<TMiceDestinationCUDResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TMiceDestinationCUDResponse");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TMiceDestinationCUDResponseStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TMiceDestinationCUDResponseTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TMiceDestinationCUDResponse.class, metaDataMap);
  }

  public TMiceDestinationCUDResponse() {
  }
   ...
   */
  public TMiceDestinationCUDResponse(TMiceDestinationCUDResponse other) {
  ...
  public TMiceDestinationCUDResponse deepCopy() {
    return new TMiceDestinationCUDResponse(this);
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TMiceDestinationCUDResponse)
      return this.equals((TMiceDestinationCUDResponse)that);
    return false;
  }

  public boolean equals(TMiceDestinationCUDResponse that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TMiceDestinationCUDResponse other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TMiceDestinationCUDResponse(");
    boolean first = true;
  ...
  private static class TMiceDestinationCUDResponseStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TMiceDestinationCUDResponseStandardScheme getScheme() {
      return new TMiceDestinationCUDResponseStandardScheme();
    }
  }

  private static class TMiceDestinationCUDResponseStandardScheme extends org.apache.thrift.scheme.StandardScheme<TMiceDestinationCUDResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TMiceDestinationCUDResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map318.size);
                ...
                for (int _i321 = 0; _i321 < _map318.size; ++_i321)
                {
                  ...
                  struct.errorList.put(_key319, _val320);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TMiceDestinationCUDResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.errorList != null) {
        oprot.writeFieldBegin(ERROR_LIST_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter322 : struct.errorList.entrySet())
          {
  ...
  private static class TMiceDestinationCUDResponseTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TMiceDestinationCUDResponseTupleScheme getScheme() {
      return new TMiceDestinationCUDResponseTupleScheme();
    }
  }

  private static class TMiceDestinationCUDResponseTupleScheme extends org.apache.thrift.scheme.TupleScheme<TMiceDestinationCUDResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TMiceDestinationCUDResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetErrorList()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter323 : struct.errorList.entrySet())
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TMiceDestinationCUDResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map324.size);
          ...
          for (int _i327 = 0; _i327 < _map324.size; ++_i327)
          {
            ...
            struct.errorList.put(_key325, _val326);
          }
        }
        struct.setErrorListIsSet(true);
      }
