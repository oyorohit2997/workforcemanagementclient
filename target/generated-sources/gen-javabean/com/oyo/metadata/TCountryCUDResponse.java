...
public class TCountryCUDResponse implements org.apache.thrift.TBase<TCountryCUDResponse, TCountryCUDResponse._Fields>, java.io.Serializable, Cloneable, Comparable<TCountryCUDResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TCountryCUDResponse");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TCountryCUDResponseStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TCountryCUDResponseTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TCountryCUDResponse.class, metaDataMap);
  }

  public TCountryCUDResponse() {
  }
   ...
   */
  public TCountryCUDResponse(TCountryCUDResponse other) {
  ...
  public TCountryCUDResponse deepCopy() {
    return new TCountryCUDResponse(this);
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TCountryCUDResponse)
      return this.equals((TCountryCUDResponse)that);
    return false;
  }

  public boolean equals(TCountryCUDResponse that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TCountryCUDResponse other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TCountryCUDResponse(");
    boolean first = true;
  ...
  private static class TCountryCUDResponseStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TCountryCUDResponseStandardScheme getScheme() {
      return new TCountryCUDResponseStandardScheme();
    }
  }

  private static class TCountryCUDResponseStandardScheme extends org.apache.thrift.scheme.StandardScheme<TCountryCUDResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TCountryCUDResponse struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TCountryCUDResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.errorList != null) {
        oprot.writeFieldBegin(ERROR_LIST_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter102 : struct.errorList.entrySet())
          {
  ...
  private static class TCountryCUDResponseTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TCountryCUDResponseTupleScheme getScheme() {
      return new TCountryCUDResponseTupleScheme();
    }
  }

  private static class TCountryCUDResponseTupleScheme extends org.apache.thrift.scheme.TupleScheme<TCountryCUDResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TCountryCUDResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetErrorList()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter103 : struct.errorList.entrySet())
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TCountryCUDResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map104.size);
          ...
          for (int _i107 = 0; _i107 < _map104.size; ++_i107)
          {
            ...
            struct.errorList.put(_key105, _val106);
          }
        }
        struct.setErrorListIsSet(true);
      }
