            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map198.size);
                ...
                for (int _i201 = 0; _i201 < _map198.size; ++_i201)
                {
                  ...
                  struct.errorList.put(_key199, _val200);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TAmenityCUDResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.errorList != null) {
        oprot.writeFieldBegin(ERROR_LIST_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter202 : struct.errorList.entrySet())
          {
      ...
      if (struct.isSetErrorList()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter203 : struct.errorList.entrySet())
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map204.size);
          java.lang.String _key205;
          java.lang.String _val206;
          for (int _i207 = 0; _i207 < _map204.size; ++_i207)
          {
            _key205 = iprot.readString();
            _val206 = iprot.readString();
            struct.errorList.put(_key205, _val206);
          }
        }
        struct.setErrorListIsSet(true);
      }
