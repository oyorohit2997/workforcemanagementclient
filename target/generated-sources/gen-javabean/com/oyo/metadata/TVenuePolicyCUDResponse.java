...
public class TVenuePolicyCUDResponse implements org.apache.thrift.TBase<TVenuePolicyCUDResponse, TVenuePolicyCUDResponse._Fields>, java.io.Serializable, Cloneable, Comparable<TVenuePolicyCUDResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TVenuePolicyCUDResponse");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TVenuePolicyCUDResponseStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TVenuePolicyCUDResponseTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TVenuePolicyCUDResponse.class, metaDataMap);
  }

  public TVenuePolicyCUDResponse() {
  }
   ...
   */
  public TVenuePolicyCUDResponse(TVenuePolicyCUDResponse other) {
  ...
  public TVenuePolicyCUDResponse deepCopy() {
    return new TVenuePolicyCUDResponse(this);
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TVenuePolicyCUDResponse)
      return this.equals((TVenuePolicyCUDResponse)that);
    return false;
  }

  public boolean equals(TVenuePolicyCUDResponse that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TVenuePolicyCUDResponse other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TVenuePolicyCUDResponse(");
    boolean first = true;
  ...
  private static class TVenuePolicyCUDResponseStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TVenuePolicyCUDResponseStandardScheme getScheme() {
      return new TVenuePolicyCUDResponseStandardScheme();
    }
  }

  private static class TVenuePolicyCUDResponseStandardScheme extends org.apache.thrift.scheme.StandardScheme<TVenuePolicyCUDResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TVenuePolicyCUDResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map498.size);
                java.lang.String _key499;
                java.lang.String _val500;
                for (int _i501 = 0; _i501 < _map498.size; ++_i501)
                {
                  _key499 = iprot.readString();
                  _val500 = iprot.readString();
                  struct.errorList.put(_key499, _val500);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TVenuePolicyCUDResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.errorList != null) {
        oprot.writeFieldBegin(ERROR_LIST_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter502 : struct.errorList.entrySet())
          {
  ...
  private static class TVenuePolicyCUDResponseTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TVenuePolicyCUDResponseTupleScheme getScheme() {
      return new TVenuePolicyCUDResponseTupleScheme();
    }
  }

  private static class TVenuePolicyCUDResponseTupleScheme extends org.apache.thrift.scheme.TupleScheme<TVenuePolicyCUDResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TVenuePolicyCUDResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetErrorList()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter503 : struct.errorList.entrySet())
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TVenuePolicyCUDResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map504.size);
          java.lang.String _key505;
          java.lang.String _val506;
          for (int _i507 = 0; _i507 < _map504.size; ++_i507)
          {
            _key505 = iprot.readString();
            _val506 = iprot.readString();
            struct.errorList.put(_key505, _val506);
          }
        }
        struct.setErrorListIsSet(true);
      }
