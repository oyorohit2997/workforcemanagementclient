...
public class TPropertyLevelCUDResponse implements org.apache.thrift.TBase<TPropertyLevelCUDResponse, TPropertyLevelCUDResponse._Fields>, java.io.Serializable, Cloneable, Comparable<TPropertyLevelCUDResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TPropertyLevelCUDResponse");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TPropertyLevelCUDResponseStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TPropertyLevelCUDResponseTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TPropertyLevelCUDResponse.class, metaDataMap);
  }

  public TPropertyLevelCUDResponse() {
  }
   ...
   */
  public TPropertyLevelCUDResponse(TPropertyLevelCUDResponse other) {
  ...
  public TPropertyLevelCUDResponse deepCopy() {
    return new TPropertyLevelCUDResponse(this);
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TPropertyLevelCUDResponse)
      return this.equals((TPropertyLevelCUDResponse)that);
    return false;
  }

  public boolean equals(TPropertyLevelCUDResponse that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TPropertyLevelCUDResponse other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TPropertyLevelCUDResponse(");
    boolean first = true;
  ...
  private static class TPropertyLevelCUDResponseStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TPropertyLevelCUDResponseStandardScheme getScheme() {
      return new TPropertyLevelCUDResponseStandardScheme();
    }
  }

  private static class TPropertyLevelCUDResponseStandardScheme extends org.apache.thrift.scheme.StandardScheme<TPropertyLevelCUDResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TPropertyLevelCUDResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map338.size);
                ...
                for (int _i341 = 0; _i341 < _map338.size; ++_i341)
                {
                  ...
                  struct.errorList.put(_key339, _val340);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TPropertyLevelCUDResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.errorList != null) {
        oprot.writeFieldBegin(ERROR_LIST_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter342 : struct.errorList.entrySet())
          {
  ...
  private static class TPropertyLevelCUDResponseTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TPropertyLevelCUDResponseTupleScheme getScheme() {
      return new TPropertyLevelCUDResponseTupleScheme();
    }
  }

  private static class TPropertyLevelCUDResponseTupleScheme extends org.apache.thrift.scheme.TupleScheme<TPropertyLevelCUDResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TPropertyLevelCUDResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetErrorList()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter343 : struct.errorList.entrySet())
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TPropertyLevelCUDResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map344.size);
          ...
          for (int _i347 = 0; _i347 < _map344.size; ++_i347)
          {
            ...
            struct.errorList.put(_key345, _val346);
          }
        }
        struct.setErrorListIsSet(true);
      }
