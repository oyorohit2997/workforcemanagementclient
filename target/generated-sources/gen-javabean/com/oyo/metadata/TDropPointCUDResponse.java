...
public class TDropPointCUDResponse implements org.apache.thrift.TBase<TDropPointCUDResponse, TDropPointCUDResponse._Fields>, java.io.Serializable, Cloneable, Comparable<TDropPointCUDResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TDropPointCUDResponse");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TDropPointCUDResponseStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TDropPointCUDResponseTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TDropPointCUDResponse.class, metaDataMap);
  }

  public TDropPointCUDResponse() {
  }
   ...
   */
  public TDropPointCUDResponse(TDropPointCUDResponse other) {
  ...
  public TDropPointCUDResponse deepCopy() {
    return new TDropPointCUDResponse(this);
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TDropPointCUDResponse)
      return this.equals((TDropPointCUDResponse)that);
    return false;
  }

  public boolean equals(TDropPointCUDResponse that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TDropPointCUDResponse other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TDropPointCUDResponse(");
    boolean first = true;
  ...
  private static class TDropPointCUDResponseStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TDropPointCUDResponseStandardScheme getScheme() {
      return new TDropPointCUDResponseStandardScheme();
    }
  }

  private static class TDropPointCUDResponseStandardScheme extends org.apache.thrift.scheme.StandardScheme<TDropPointCUDResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TDropPointCUDResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map458.size);
                java.lang.String _key459;
                java.lang.String _val460;
                for (int _i461 = 0; _i461 < _map458.size; ++_i461)
                {
                  _key459 = iprot.readString();
                  _val460 = iprot.readString();
                  struct.errorList.put(_key459, _val460);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDropPointCUDResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.errorList != null) {
        oprot.writeFieldBegin(ERROR_LIST_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter462 : struct.errorList.entrySet())
          {
  ...
  private static class TDropPointCUDResponseTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TDropPointCUDResponseTupleScheme getScheme() {
      return new TDropPointCUDResponseTupleScheme();
    }
  }

  private static class TDropPointCUDResponseTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDropPointCUDResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TDropPointCUDResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetErrorList()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter463 : struct.errorList.entrySet())
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TDropPointCUDResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map464.size);
          java.lang.String _key465;
          java.lang.String _val466;
          for (int _i467 = 0; _i467 < _map464.size; ++_i467)
          {
            _key465 = iprot.readString();
            _val466 = iprot.readString();
            struct.errorList.put(_key465, _val466);
          }
        }
        struct.setErrorListIsSet(true);
      }
