...
public class TRoasterMarkUnAvailableRequest implements org.apache.thrift.TBase<TRoasterMarkUnAvailableRequest, TRoasterMarkUnAvailableRequest._Fields>, java.io.Serializable, Cloneable, Comparable<TRoasterMarkUnAvailableRequest> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TRoasterMarkUnAvailableRequest");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TRoasterMarkUnAvailableRequestStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TRoasterMarkUnAvailableRequestTupleSchemeFactory();

  private long userProfileId; // required
  private long dateTime; // required
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TRoasterMarkUnAvailableRequest.class, metaDataMap);
  }

  public TRoasterMarkUnAvailableRequest() {
  }
   ...
   */
  public TRoasterMarkUnAvailableRequest(TRoasterMarkUnAvailableRequest other) {
    __isset_bitfield = other.__isset_bitfield;
    this.userProfileId = other.userProfileId;
    this.dateTime = other.dateTime;
  }

  public TRoasterMarkUnAvailableRequest deepCopy() {
    return new TRoasterMarkUnAvailableRequest(this);
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case DATE_TIME:
      if (value == null) {
        ...
        setDateTime((java.lang.Long)value);
      }
      break;
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TRoasterMarkUnAvailableRequest)
      return this.equals((TRoasterMarkUnAvailableRequest)that);
    return false;
  }

  public boolean equals(TRoasterMarkUnAvailableRequest that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + org.apache.thrift.TBaseHelper.hashCode(dateTime);

    return hashCode;
  }

  @Override
  public int compareTo(TRoasterMarkUnAvailableRequest other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TRoasterMarkUnAvailableRequest(");
    boolean first = true;
  ...
  private static class TRoasterMarkUnAvailableRequestStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TRoasterMarkUnAvailableRequestStandardScheme getScheme() {
      return new TRoasterMarkUnAvailableRequestStandardScheme();
    }
  }

  private static class TRoasterMarkUnAvailableRequestStandardScheme extends org.apache.thrift.scheme.StandardScheme<TRoasterMarkUnAvailableRequest> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TRoasterMarkUnAvailableRequest struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TRoasterMarkUnAvailableRequest struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class TRoasterMarkUnAvailableRequestTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TRoasterMarkUnAvailableRequestTupleScheme getScheme() {
      return new TRoasterMarkUnAvailableRequestTupleScheme();
    }
  }

  private static class TRoasterMarkUnAvailableRequestTupleScheme extends org.apache.thrift.scheme.TupleScheme<TRoasterMarkUnAvailableRequest> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TRoasterMarkUnAvailableRequest struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TRoasterMarkUnAvailableRequest struct) throws org.apache.thrift.TException {
